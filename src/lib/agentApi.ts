        ...
        messages: [
          {
            ...
            content: [
              '你是一个生图提示词反推助手。',
              '你的任务不是解释图片，也不是做海报分析，而是输出一段可直接用于再次生图的中文提示词。',
              '输出风格必须像生图 prompt，而不是说明文。',
            ].join('\n'),
          },
          {
            role: 'user',
            content: [
              ...
              },
              {
                ...
                text: [
                  ...
                  '要求：',
                  '1. 只输出可直接复用的中文提示词正文。',
                  '2. 不要输出解释、前后缀、标题、编号、Markdown、引号。',
                  '3. 不要输出“这张图里有……”这类说明文口吻。',
                  '4. 不要逐条分析画面，不要写海报排版分析，不要翻译图片中的文字。',
                  '5. 不要输出 4k、8k、ar、--v 之类参数尾巴。',
                  '6. 更像创作提示词：主体、服装、动作、构图、镜头、光线、场景、风格，尽量精炼但信息完整。',
                  '7. 如果是人物图，优先保留人物外观、服饰、姿态、表情和环境氛围。',
                ].join('\n'),
              },
            ],
          },
